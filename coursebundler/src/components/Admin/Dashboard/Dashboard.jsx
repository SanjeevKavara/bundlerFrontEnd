        ...
        <Grid style={{ cursor: `url(${cursorr}), auto` }}
            ...
            <Box boxSizing='border-box' py={'16'} px={['4', '0']}>
                ...
                >
                    ...
                    <DataBox title='Users' qty={300} qtyPercentage={50} profit={true} />
                    <DataBox title='Donation' qty={100} qtyPercentage={60} profit={false} />
                ...
                <Grid templateColumns={['1fr', '2fr 1fr']} >
                    <Box p='4'>
                        ...
                        <Box>
                            ...
                            <Bar profit={false} title='Donation' value={10} />
